...
if __name__ == '__main__':
    ...
    url = "https://www.tujigu.com/t/3156/"
    html = gethtml(url)
    ...
    for line in html:
        ...
        if line_ != None:
            ...
            # print(pattern2)
            # print(f"https://www.tujigu.com/a/36562(\d*).html")
            title = None
            for line2 in html2:
                if title==None:
            ...
            #         print(line_2)
                # print(line2)
                # print()
                # line_2 = re.search(pattern2, str(line2), re.M | re.S)
                # if line_2 != None:
                #     print(line_2.group())


            # < img
            # src = "https://lns.hywly.com/a/1/33418/1.jpg"
            # alt = "周于希Sandy《黑色主题内衣》 [尤蜜荟YouMi] Vol.379 写真集1"
            #
            #
            # class ="tupian_img" original="https://lns.hywly.com/a/1/33418/1.jpg" title="点击查看超高清图片" >
